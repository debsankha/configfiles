...
# variable IPYTHONDIR.
# c.NotebookApp.ipython_dir = u'/home/dmanik/.ipython'
...
# $HOME/.ipython. This options can also be specified through the environment
# variable IPYTHONDIR.
# c.IPKernelApp.ipython_dir = u'/home/dmanik/.ipython'
...
c.InlineBackend.rc = {'figure.figsize': (15.0, 10.0),\
     ...
     'font.size': 30.0, 'text.usetex': True,\
     'xtick.major.size': 10,\
     'xtick.minor.size': 5, 'ytick.major.size': 10,\
     'ytick.minor.size': 5, 'legend.fancybox': True, \
     'legend.framealpha': 0.3, 'lines.linewidth': 3}
...
# The directory to use for notebooks.
# c.FileNotebookManager.notebook_dir = u'/home/dmanik'
